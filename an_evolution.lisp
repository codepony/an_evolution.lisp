...
(format t "~%type `down-source' to get a copy of the source-code in you current directory (Only works in CLISP. wget required)")
...
;;                              (bye) ;; Uncomment this before building Because saying good-bye is always fine.
          ...
          ((equal str "source") (format t "~%Look at the source here: https://gist.github.com/4460470~%")
                                (evolution))
          ((equal str "down-source") (run-shell-command "wget https://gist.github.com/4460470/download -O an_evolution.lisp.tar.gz")
                                     (fresh-line) (princ #\newline)
                                     (evolution))
          ((equal str "lightning")
